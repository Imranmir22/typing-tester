...
export default function TypingMaster() {
    ...
    return ( <
        ...
        <
        div className = "bg-white rounded-2xl shadow-2xl p-8" > { " " } { /* Header */ } { " " } <
        ...
        Reset { " " } <
        /button>{" "} <
        /div> { /* Main Layout: Left Sidebar + Center Content */ } { " " } <
        div className = "flex gap-6" > { " " } { /* Left Sidebar - Stats */ } { " " } <
        div className = "w-80 flex-shrink-0 space-y-4" > { " " } { /* Logo */ } { " " } <
        ...
        div className = "text-5xl font-bold" > { " " } { formatTime(timeLeft) } { " " } <
        /div>{" "} <
        /div> { /* Speed */ } { " " } <
        ...
        div className = "text-sm opacity-90" > { " " } { errors }
        errors { " " } <
        /div>{" "} <
        /div> { /* Words */ } { " " } <
        ...
        div className = "text-4xl font-bold" > { " " } { completedWords.length } { " " } <
        /div>{" "} <
        div className = "text-sm opacity-90" > of { words.length } < /div>{" "} <
        /div>{" "} <
        /div> { /* Center Content - Typing Area */ } { " " } <
        div className = "flex-1" > { " " } { /* Time Limit Selection */ } { " " } {
            !started && ( <
        ...
        div className = "bg-gray-50 p-6 rounded-xl mb-6 border-2 border-gray-200 max-h-64 overflow-y-auto" >
        <
        p className = "text-2xl leading-relaxed font-mono flex flex-wrap gap-x-3 gap-y-2" > { " " } {
        ...
        className = "w-full p-4 text-xl border-2 border-indigo-300 rounded-xl focus:outline-none focus:border-indigo-500 font-mono resize-none disabled:bg-gray-100 disabled:cursor-not-allowed"
        rows = "5"
        autoFocus /
        >
        <
        ...
        /div> { /* Finish Message */ } { " " } {
            finished && ( <
                ...
                p className = "mb-2" >
                <
                span className = "font-bold text-green-600 text-2xl" > { " " } { wpm }
                WPM { " " } <
                /span>{" "} <
                /p>{" "} <
                p className = "mb-2" >
                <
                span className = "font-bold text-green-600 text-2xl" > { " " } { accuracy } % Accuracy { " " } <
                /span>{" "} <
                /p>{" "} <
                p className = "text-gray-600" >
                You typed { " " } <
                span className = "font-bold" > { " " } { completedWords.length } { " " } <
                /span>{" "}
            ...
            !started && ( <
                ...
                <
                p className = "text-gray-700" > { " " }💡 < span className = "font-semibold" > Tip: < /span> Select your
